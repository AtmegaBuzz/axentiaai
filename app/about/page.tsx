...
function OrbitRing({ className = '', size = 120, color = '#d946ef' }: { className?: string; size?: number; color?: string }) {
  return (
    ...
    <div className={`pointer-events-none ${className}`} style={{ width: size, height: size }}>
      <svg viewBox="0 0 80 80" fill="none" className="w-full h-full">
        <motion.g animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 30, ease: 'linear' }}>
          <circle cx="40" cy="40" r="30" stroke="#e879f9" strokeWidth="1" opacity="0.25" strokeDasharray="4 8" />
        </motion.g>
        ...
        <motion.g animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 15, ease: 'linear' }}>
          <circle cx="40" cy="40" r="10" stroke="#e879f9" strokeWidth="0.75" opacity="0.3" strokeDasharray="2 4" />
        </motion.g>
        <circle cx="40" cy="40" r="2" fill="#d946ef" opacity="0.4" />
      </svg>
    </div>
  );
}
...
/* Rotating cross/plus */
function RotatingCross({ className = '', color = '#d946ef' }: { className?: string; color?: string }) {
  return (
...
/* Floating diamond */
function FloatingDiamond({ className = '', color = '#d946ef' }: { className?: string; color?: string }) {
  return (
      ...
      <svg viewBox="0 0 1200 60" fill="none" className="w-full h-full" preserveAspectRatio="none">
        ...
        <defs>
          <linearGradient id="flowGrad" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <stop offset="20%" stopColor="#d946ef" stopOpacity="0.3" />
  ...
  return (
    <section ref={ref} className="relative h-[160vh]">
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, #1e1b4b 0%, #312e81 30%, #4c1d95 60%, #581c87 100%)' }} />
        {/* SVG curves */}
        <svg className="absolute inset-0 w-full h-full opacity-[0.08] pointer-events-none" preserveAspectRatio="none" viewBox="0 0 1440 900">
          ...
          <defs>
            <linearGradient id="hg1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#e879f9" /><stop offset="100%" stopColor="#facc15" /></linearGradient>
            <linearGradient id="hg2" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#facc15" /><stop offset="100%" stopColor="#e879f9" /></linearGradient>
          </defs>
        </svg>
        ...
        {/* Rotating widgets */}
        <OrbitRing className="absolute top-20 right-[15%] hidden lg:block" size={140} color="#e879f9" />
        ...
        <FloatingDiamond className="absolute bottom-[20%] right-[25%] w-6 h-6 hidden md:block" color="#e879f9" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          <FadeIn delay={0.1}>
            <div className="relative">
              ...
              <OrbitRing className="absolute -bottom-10 -left-10 hidden lg:block" size={100} color="#d946ef" />
            </div>
          </FadeIn>
        </div>
      </div>
    ...
    <section ref={containerRef} className="relative" style={{ height: '300vh' }}>
      <div className="sticky top-0 h-screen overflow-hidden bg-gradient-to-b from-slate-50 via-brand-50/20 to-slate-50">
        <svg className="absolute inset-0 w-full h-full opacity-[0.04] pointer-events-none" preserveAspectRatio="none" viewBox="0 0 1440 900">
          <path d="M-100,450 Q360,200 720,450 T1540,450" stroke="#d946ef" strokeWidth="3" fill="none" />
          <path d="M-100,350 Q500,600 1000,350 T1540,350" stroke="#eab308" strokeWidth="2" fill="none" />
        </svg>
        {/* Rotating widgets */}
        <OrbitRing className="absolute top-8 right-8 hidden lg:block" size={100} color="#d946ef" />
...
function NumbersSection() {
  ...
  return (
    <section ref={ref} className="relative py-24 md:py-36 overflow-hidden">
      <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, #581c87 0%, #7c3aed 40%, #4c1d95 70%, #312e81 100%)' }} />
      ...
      {/* Rotating widgets */}
      <OrbitRing className="absolute top-12 left-12 hidden lg:block" size={120} color="#e879f9" />
...
function ValuesSection() {
  return (
    <section className="relative py-24 md:py-36 overflow-hidden">
      <div className="absolute inset-0 animate-gradient-loop" style={{ background: 'linear-gradient(135deg, #fdf4ff 0%, #fae8ff 25%, #fefce8 50%, #fdf4ff 75%, #f5d0fe 100%)' }} />
      ...
      <svg className="absolute inset-0 w-full h-full opacity-[0.08] pointer-events-none" preserveAspectRatio="none" viewBox="0 0 1440 800">
        <path d="M0,250 C360,150 720,350 1440,250" stroke="#d946ef" strokeWidth="1.5" fill="none" />
      ...
      <RotatingCross className="absolute bottom-[25%] right-12 w-7 h-7 hidden md:block" color="#d946ef" />
        ...
        <FadeIn delay={0.15}>
          <div className="hidden lg:block relative h-12 mb-6 max-w-3xl mx-auto">
            <svg className="w-full h-full" viewBox="0 0 600 48" preserveAspectRatio="xMidYMid meet">
              <motion.path d="M100,8 L100,28 Q100,44 160,44 L300,44 Q340,44 340,28 L340,8" stroke="#d946ef" strokeWidth="2" fill="none" initial={{ pathLength: 0 }} whileInView={{ pathLength: 1 }} viewport={{ once: true }} transition={{ duration: 1.2, delay: 0.3 }} />
              ...
              <motion.circle cx="300" cy="44" r="4" fill="#d946ef" initial={{ scale: 0 }} whileInView={{ scale: 1 }} viewport={{ once: true }} transition={{ delay: 1 }} />
            </svg>
          </div>
        </FadeIn>
    ...
    <section ref={sectionRef} className="relative py-24 md:py-40 overflow-hidden border-y border-slate-200" style={{ background: 'linear-gradient(180deg, #fafafa 0%, #f1f0fb 40%, #faf5ff 70%, #fafafa 100%)' }}>
      ...
      <motion.div style={{ y: bgY }} className="absolute inset-0 pointer-events-none">
        <svg className="absolute inset-0 w-full h-full opacity-[0.04]" preserveAspectRatio="none" viewBox="0 0 1440 800">
          <pattern id="teamDotPat" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse"><circle cx="20" cy="20" r="1.5" fill="#7c3aed" /></pattern>
      ...
      {/* Widgets */}
      <OrbitRing className="absolute top-12 right-16 hidden lg:block" size={110} color="#d946ef" />
      ...
      <FloatingDiamond className="absolute bottom-16 right-[20%] w-7 h-7 hidden md:block" />
      <RotatingCross className="absolute top-32 left-[30%] w-6 h-6 hidden lg:block" color="#d946ef" />
    ...
    <section ref={ref} className="py-12 md:py-20 bg-white">
      <div className="container mx-auto px-6 md:px-12 xl:px-20">
        <motion.div style={{ scale, borderRadius }} className="relative overflow-hidden shadow-2xl">
          <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, #7c3aed 0%, #c026d3 50%, #d946ef 100%)' }} />
