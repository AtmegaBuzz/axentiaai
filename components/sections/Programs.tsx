...
function ProgramCard({ prog }: { prog: Program }) {
    ...
    return (
        <div className="group relative bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl transition-shadow duration-300 flex flex-col overflow-hidden">
        ...
        <section id="programs" className="relative py-16 md:py-24 bg-slate-50">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <div className="text-brand-600 font-semibold tracking-wide uppercase text-sm mb-4">
                        Programs
                    </div>
