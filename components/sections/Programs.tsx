...
const programs = [
    {
        ...
        timeline: [
            '4 months full-time classroom learning in Noida',
    ...
    },
    {
        ...
        learnList: [
            ...
            'Presales and estimation support',
            'AI use cases within enterprise projects',
            'Handling larger responsibilities within teams',
        ],
    ...
    },
    {
        ...
        learnList: [
            ...
            'Introductory structured modules',
            'This pathway allows you to explore before committing to the full DCAP program.',
        ],
        ...
        <section id="programs" className="py-24 bg-slate-50 relative">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    ...
                    >
                        Three options depending on where you are and what you're looking for.
                    </motion.p>
                </div>
                    ...
                    {programs.map((prog, idx) => (
                        ...
                        >
                            <div className="flex items-center justify-between mb-6">
                                <span className={`px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider ${prog.badgeColor}`}>
                                    {prog.badge}
                                </span>
                            ...
                            <div className="mt-auto pt-6 border-t border-slate-100 flex items-center justify-between">
                                <p className="text-xs font-medium text-slate-500 max-w-[60%]">{prog.meta}</p>
