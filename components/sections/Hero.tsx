...
export function Hero() {
    ...
    return (
        <section ref={sectionRef} className="relative h-screen flex flex-col overflow-hidden bg-black">
            {/* Background Video */}
            ...
            {/* Main content — bottom left, parallax on scroll */}
            <motion.div className="relative z-10 flex-1 flex items-end" style={{ y: contentY, opacity: contentOpacity }}>
